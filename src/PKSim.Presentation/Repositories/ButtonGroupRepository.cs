...
namespace PKSim.Presentation.Repositories
{
   public class ButtonGroupRepository : OSPSuite.Presentation.Repositories.ButtonGroupRepository
   {
      ...
      private IButtonGroup projectButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.File)
      ...
      private IButtonGroup importButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Import)
      ...
      private IButtonGroup importPopulationSimulationButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Import)
      ...
      private IButtonGroup exportIndividualSimulationGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Export)
      ...
      private IButtonGroup exportPopulationSimulationGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Export)
      ...
      private IButtonGroup exportProjectGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.ExportProject)
               .WithButton(
      ...
      private IButtonGroup createButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Create)
      ...
      private IButtonGroup compareButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.CompareResults)
      ...
      private IButtonGroup displayUnitsButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.DisplayUnits)
      ...
      private IButtonGroup loadBuildingBlocksButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.LoadBuildingBlocks)
      ...
      private IButtonGroup toolsButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Tools)
               .WithButton(CreateRibbonButton.From(_menuBarItemRepository.Find(MenuBarItemIds.Options)))
               .WithId(ButtonGroupIds.Tools);
         }
      }

      private IButtonGroup adminButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Admin)
      ...
      private IButtonGroup viewButtonGroup
      {
         ...
         {
            return
               CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.PanelView)
      ...
      private IButtonGroup runSimulationButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Simulation)
      ...
      private IButtonGroup individualSimulationAnalysesButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Analyses)
      ...
      private IButtonGroup populationSimulationAnalysesButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Analyses)
      ...
      private IButtonGroup populationSimulationWorkflowButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Workflow)
      ...
      private IButtonGroup journalButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.WorkingJournal)
      ...
      private IButtonGroup favoritesButtonGroup
      {
         get
         {
            return CreateButtonGroup.WithCaption(PKSimConstants.Ribbons.Favorites)
