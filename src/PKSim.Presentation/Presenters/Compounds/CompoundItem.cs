...
public class CompoundItems
{
   ...
   public static CompoundItem<IOverwriteParameterSetsPresenter> OverwriteParameterSets = new CompoundItem<IOverwriteParameterSetsPresenter>();
   ...
   public static readonly IReadOnlyList<ISubPresenterItem> All = new List<ISubPresenterItem> { Parameters, Processes, AdvancedParameters, OverwriteParameterSets };
}