...
namespace PKSim.Presentation.Presenters.Compounds
{
   ...
   public class IntestinalPermeabilityGroupPresenter : PermeabilityGroupPresenterBase, IIntestinalPermeabilityGroupPresenter
   {
      ...
      {
         return _parameterGroup.AllAlternatives.Select(alternative => _permeabilityAlternativeDTOMapper.MapFrom(alternative, CoreConstants.Parameter.SpecificIntestinalPermeability));
      }
   }
}