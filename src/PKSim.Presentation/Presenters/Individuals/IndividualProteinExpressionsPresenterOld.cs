...
{
   public interface IIndividualProteinExpressionsPresenterOld : IIndividualMoleculeExpressionsPresenter
   {
   ...
   public abstract class IndividualProteinExpressionsPresenterOld<TProtein, TSimulationSubject> : EditParameterPresenter<IIndividualProteinExpressionsViewOld, IIndividualProteinExpressionsPresenterOld>, IIndividualProteinExpressionsPresenterOld
      ...
      where TSimulationSubject : ISimulationSubject
   {
      ...
      protected IndividualProteinExpressionsPresenterOld(IIndividualProteinExpressionsViewOld view, IEditParameterPresenterTask parameterTask,
