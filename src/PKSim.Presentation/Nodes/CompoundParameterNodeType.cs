...
namespace PKSim.Presentation.Nodes
{
   public class CompoundParameterNodeType : RootNodeType
   {
      ...
      public static readonly CompoundParameterNodeType AdvancedSolubility = new CompoundParameterNodeType(PKSimConstants.UI.AdvancedSolubility, ApplicationIcons.Formulation);
