...
{
   public partial class IndividualProteinExpressionsViewOld : BaseUserControlWithValueInGrid, IIndividualProteinExpressionsViewOld
   {
      ...
      protected IIndividualProteinExpressionsPresenterOld _presenter;
      ...
      public IndividualProteinExpressionsViewOld(IImageListRetriever imageListRetriever)
      {
         InitializeComponent();
      ...
      public void AttachPresenter(IIndividualProteinExpressionsPresenterOld presenter)
      {
