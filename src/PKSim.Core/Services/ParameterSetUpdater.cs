...
namespace PKSim.Core.Services
{
   public interface IParameterSetUpdater
   {
      ...
      IPKSimMacroCommand UpdateValues(IContainer sourceContainer, IContainer targetContainer);
      ...
      /// </summary>
      IPKSimMacroCommand UpdateValues(IEnumerable<IParameter> sourceParameters, IEnumerable<IParameter> targetParameters);
      ...
      /// </summary>
      IPKSimMacroCommand UpdateValues(PathCache<IParameter> sourceParameters, PathCache<IParameter> targetParameters, bool updateParameterOriginId = true);
      ...
      /// <param name="targetContainer">container for which the parameter values should be updated</param>
      /// <returns></returns>
      IPKSimMacroCommand UpdateValuesByName(IContainer sourceContainer, IContainer targetContainer);
      ...
      /// </summary>
      IPKSimMacroCommand UpdateValuesByName(IEnumerable<IParameter> sourceParameters, IEnumerable<IParameter> targetParameters);
      ...
      /// <returns></returns>
      IPKSimMacroCommand UpdateValuesByName(IContainer sourceContainer, IEnumerable<IParameter> targetParameters);
   ...
   public class ParameterSetUpdater : IParameterSetUpdater
   {
      ...
      public IPKSimMacroCommand UpdateValues(IContainer sourceContainer, IContainer targetContainer)
      {
         return UpdateValues(sourceContainer.GetAllChildren<IParameter>(), targetContainer.GetAllChildren<IParameter>());
      }

      public IPKSimMacroCommand UpdateValues(IEnumerable<IParameter> sourceParameters, IEnumerable<IParameter> targetParameters)
      {
      ...
      public IPKSimMacroCommand UpdateValuesByName(IContainer sourceContainer, IContainer targetContainer)
      {
         return UpdateValuesByName(sourceContainer, targetContainer.GetChildren<IParameter>());
      }

      public IPKSimMacroCommand UpdateValuesByName(IContainer sourceContainer, IEnumerable<IParameter> targetParameters)
      {
