...
{
   public class NormalDistributionFormulaSpecificationFactory : IDistributionFormulaSpecificationFactory
   {
      ...
      public DistributionFormula CreateFor(IEnumerable<ParameterDistributionMetaData> distributions,
