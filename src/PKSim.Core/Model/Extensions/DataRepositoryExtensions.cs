...
namespace PKSim.Core.Model.Extensions
{
   public static class DataRepositoryExtensions
   {
      ...
      {
         return dataRepository.drugColumnFor(CoreConstants.Organ.VenousBlood, CoreConstants.Compartment.Plasma, CoreConstants.Observer.CONCENTRATION, compoundName);
      }
