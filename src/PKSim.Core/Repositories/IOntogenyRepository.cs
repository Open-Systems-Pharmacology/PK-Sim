...
namespace PKSim.Core.Repositories
{
   public interface IOntogenyRepository : IStartableRepository<Ontogeny>
   {
      ...
      DataRepository OntogenyToRepository(Ontogeny ontogeny, string containerName, Unit xUnit = null, Unit yUnit = null);
      DistributedTableFormula DataRepositoryToDistributedTableFormula(DataRepository ontogenyDataRepository);
      DistributedTableFormula OntogenyToDistributedTableFormula(Ontogeny ontogeny, string containerName, Unit xUnit = null, Unit yUnit = null);
