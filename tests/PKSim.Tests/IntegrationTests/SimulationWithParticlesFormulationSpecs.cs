...
namespace PKSim.IntegrationTests
{
   ...
   public class when_running_particles_simulation_with_two_bins_without_precipitation_with_all_model_options_toggled : concern_for_SimulationWithParticlesFormulation
   {
      protected override int NumberOfBins => 2;
   ...
   public class when_running_particles_simulation_with_two_bins_without_precipitation_with_effective_diffusion_without_hydrodynamic_model : concern_for_SimulationWithParticlesFormulation
   {
      protected override int NumberOfBins => 2;
