...
{
   public abstract class concern_for_ExpressionParametersToSimulationExpressionsDTOMapper : ContextForIntegration<IExpressionParametersToSimulationExpressionsDTOMapper>
   {
      ...
      public override void GlobalContext()
      {
         ...
         _simulation.AddUsedBuildingBlock(new UsedBuildingBlock("Ind", PKSimBuildingBlockType.Individual) {BuildingBlock = DomainHelperForSpecs.CreateIndividual() });
   ...
   public class When_mapping_a_list_of_parameters_to_a_simulation_expression_dto : concern_for_ExpressionParametersToSimulationExpressionsDTOMapper
   {
      ...
      protected override void Context()
      {
         ...
         _halfLifeLiverParameter = DomainHelperForSpecs.ConstantParameterWithValue(0).WithName(CoreConstants.Parameter.HALF_LIFE_LIVER);
         _halfLifeLiverIntestineParameter = DomainHelperForSpecs.ConstantParameterWithValue(0).WithName(CoreConstants.Parameter.HALF_LIFE_INTESTINE);
