...
namespace PKSim.ProjectConverter.v5_1
{
   ...
   public class When_converting_the_project_Test4Convert : concern_for_Test4Convert_504
   {
      ...
      public void should_have_the_value_of_sink_condition_to_the_expected_values()
      {
         ...
         lumen.Parameter(CoreConstants.Parameters.PARA_ABSORPTION_SINK).Value.ShouldBeEqualTo(CoreConstants.Parameters.SINK_CONDITION);
         lumen.Parameter(CoreConstants.Parameters.TRANS_ABSORPTION_SINK).Value.ShouldBeEqualTo(CoreConstants.Parameters.NO_SINK_CONDITION);
      }
