...
namespace PKSim.Presentation
{
   ...
   public abstract class When_deleting_a_pksim_event : concern_for_BuildingBlockTask
   {
      ...
      {
         await base.Context();
         //the real manager is used so that the deletion check runs against the actual event mappings
         sut = new BuildingBlockTask(
            _executionContext,
            _applicationController,
            _dialogCreator,
            new BuildingBlockInProjectManager(_buildingBlockRepository, A.Fake<IEventPublisher>()),
            _entityTask,
            _templateTaskQuery,
            _singleStartPresenterTask,
            _buildingBlockRepository,
   ...
   public class When_deleting_a_pksim_event_mapped_in_a_simulation_via_an_event_placeholder_mapping : When_deleting_a_pksim_event
   {
      protected override async Task Context()
      {
         await base.Context();
   ...
   public class When_deleting_a_pksim_event_not_mapped_in_any_simulation : When_deleting_a_pksim_event
   {
