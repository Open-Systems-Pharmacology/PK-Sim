...
namespace PKSim.Presentation
{
   ...
   public class When_loading_a_population_analyses_that_matches_the_given_population_simulation : concern_for_PopulationAnalysisTemplateTask
   {
      ...
      {
         _result = await sut.LoadPopulationAnalysisForAsync<PopulationPivotAnalysis>(_populationDataCollector);
      }
   ...
   public abstract class concern_for_LoadingDerivedFieldFromTemplate : concern_for_PopulationAnalysisTemplateTask
   {
      ...
      protected override async Task Context()
      {
         ...
         A.CallTo(_templateTask).WithReturnType<Task<PopulationAnalysisDerivedField>>().Returns(_derivedField);
   ...
   public class When_loading_a_derived_field_with_a_name_that_already_exist : concern_for_LoadingDerivedFieldFromTemplate
   {
      ...
      protected override async Task Because()
      {
         _derivedField = await sut.LoadDerivedFieldForAsync(_populationAnalysis, _dataField);
      }
   ...
   public class When_loading_a_derived_field_for_a_field_that_does_not_have_the_appropriate_type : concern_for_LoadingDerivedFieldFromTemplate
   {
      ...
      {
         The.Action(() => sut.LoadDerivedFieldForAsync(_populationAnalysis, _dataField)).ShouldThrowAn<PKSimException>();
      }
   }
   ...
   public class When_loading_some_simulation_workflow_into_an_population_simulation_and_the_user_cancels : concern_for_PopulationAnalysisTemplateTask
   {
      ...
      protected override async Task Context()
      {
         ...
         A.CallTo(() => _templateTask.LoadSingleFromTemplateAsync<SimulationAnalysisWorkflow>(TemplateType.PopulationSimulationAnalysisWorkflow))
            .Returns((SimulationAnalysisWorkflow)null);
      }

      protected override Task Because()
      {
         return sut.LoadPopulationAnalysisWorkflowIntoAsync(_populationSimulation);
      }
   ...
   public class When_loading_some_simulation_workflow_into_an_population_simulation : concern_for_PopulationAnalysisTemplateTask
   {
      ...
      protected override async Task Context()
      {
         ...
         A.CallTo(() => _templateTask.LoadSingleFromTemplateAsync<SimulationAnalysisWorkflow>(TemplateType.PopulationSimulationAnalysisWorkflow)).Returns(_workflow);
      }
