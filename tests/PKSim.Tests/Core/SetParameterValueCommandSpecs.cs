...
namespace PKSim.Core
{
   ...
   public class When_setting_the_value_of_a_compound_dependent_simulation_parameter : concern_for_SetParameterValueCommand
   {
   ...
   public class When_setting_the_value_of_a_non_compound_dependent_simulation_parameter : concern_for_SetParameterValueCommand
   {
      private IndividualSimulation _simulation;
      private IEntityPathResolver _entityPathResolver;
      ...
      protected override void Context()
      {
         ...
         A.CallTo(() => _executionContext.Get<Simulation>("SimId")).Returns(_simulation);
         A.CallTo(() => _executionContext.Resolve<IEntityPathResolver>()).Returns(_entityPathResolver);
         A.CallTo(() => _entityPathResolver.PathFor(_parameter)).Returns("Organism|Liver|Volume");
   ...
   public class When_setting_the_value_of_a_non_simulation_building_block_parameter : concern_for_SetParameterValueCommand
   {
      protected override void Context()
      {
         base.Context();
