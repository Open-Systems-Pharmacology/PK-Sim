...
{
   public abstract class concern_for_ScatterChartsDataCreator : ContextSpecification<IScatterChartDataCreator>
   {
   ...
   public class When_creating_the_scatter_chart_data_based_on_valid_data_containing_grouping_on_rows_and_columns : concern_for_ScatterChartsDataCreator
   {
   ...
   public class When_creating_the_scatter_chart_data_based_on_valid_data_containing_only_grouping_on_columns : concern_for_ScatterChartsDataCreator
   {
      private PivotResult _pivotResult;
      private ChartData<ScatterXValue, ScatterYValue> _chartData;
   ...
   public class When_creating_the_scatter_chart_data_based_on_valid_data_containing_only_grouping_on_rows : concern_for_ScatterChartsDataCreator
   {
      private PivotResult _pivotResult;
      private ChartData<ScatterXValue, ScatterYValue> _chartData;
