...
namespace PKSim.Core
{
   public abstract class concern_for_BuildConfigurationTask : ContextSpecification<IBuildConfigurationTask>
   {
      ...
      protected override void Context()
      {
         ...
         sut = new BuildConfigurationTask(_spatialStructureFactory, _modelObserverQuery, _modelPassiveTransportQuery, _parameterStartValueCreator,
                                          _moleculesAndReactionsCreator, _eventBuildingBlockCreator, _moleculeStartValueCreator, _moleculeCalculationRetriever, _distributedTableConverter);
      }
   }
   ...
   public class When_validating_the_configuration_of_a_valid_simulation_using_the_two_pore_model : concern_for_BuildConfigurationTask
   {
      protected override void Context()
      {
         base.Context();
   ...
   public class When_validating_the_configuration_of_a_valid_simulation_using_the_four_comp_model : concern_for_BuildConfigurationTask
   {
      protected override void Context()
      {
         base.Context();
   ...
   public class When_validating_the_configuration_of_a_simulation_using_a_small_molecule_with_the_two_pores_model : concern_for_BuildConfigurationTask
   {
      protected override void Context()
      {
         base.Context();
   ...
   public class When_validating_the_configuration_of_a_simulation_using_a_large_molecule_with_the_4comp_model : concern_for_BuildConfigurationTask
   {
      protected override void Context()
      {
         base.Context();
   ...
   public class When_validating_the_configuration_of_a_simulation_using_a_compound_with_the_same_name_as_the_simulation : concern_for_BuildConfigurationTask
   {
      protected override void Context()
      {
         base.Context();
   ...
   public class When_validating_the_configuration_of_a_simulation_using_an_individudal_molecule_with_the_same_name_as_the_simulation : concern_for_BuildConfigurationTask
   {
      protected override void Context()
      {
         base.Context();
