...
{
   public abstract class concern_for_BatchPopulationSettingsToPopulationSettingsMapper : ContextSpecification<IPopulationSettingsMapper>
   {
      private IOriginDataMapper _orginDataMapper;
   ...
   public class When_mapping_the_batch_population_settings_to_some_population_settings : concern_for_BatchPopulationSettingsToPopulationSettingsMapper
   {
      private Individual _individual;
      private RandomPopulationSettings _populationSettings;
      private Batch.PopulationSettings _batchPopSettings;
