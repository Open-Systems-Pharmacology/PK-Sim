...
namespace PKSim.Infrastructure
{
   ...
   public class When_serializing_an_entity : concern_for_XmlSerializationManager
   {
      ...
      [Observation]
      public void should_leverage_the_xml_writer_to_retrieve_the_xml_string()
      {
   ...
   public class When_deserializing_an_individual_from_a_previous_version : concern_for_XmlSerializationManager
   {
      ...
      protected override void Context()
      {
         ...
         A.CallTo(() => _objectConverterFinder.FindConverterFor(ProjectVersions.V7_1_0)).Returns(_converter);
         _element = new XElement("Individual");
         _element.AddAttribute(CoreConstants.Serialization.Attribute.XmlVersion, ProjectVersions.V7_1_0.VersionAsString);
         A.CallTo(() => _converter.Convert(_individual, ProjectVersions.V7_1_0)).Returns((ProjectVersions.Current, true));
         A.CallTo(() => _converter.ConvertXml(A<XElement>._, ProjectVersions.V7_1_0)).Returns((ProjectVersions.Current, true));
      }
      ...
      {
         A.CallTo(() => _converter.Convert(_individual, ProjectVersions.V7_1_0)).MustHaveHappened();
      }
