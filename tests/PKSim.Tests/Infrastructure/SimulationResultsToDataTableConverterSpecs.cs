...
namespace PKSim.Infrastructure
{
   ...
   public class When_creating_a_data_table_based_on_the_pk_analyses_of_a_population_simulation : concern_for_SimulationResultsToDataTableConverter
   {
      ...
      public void should_return_a_table_containing_the_expected_columns_in_the_expected_order()
      {
         ...
         _dataTable.Columns[0].ColumnName.ShouldBeEqualTo(CoreConstants.SimulationResults.INDIVIDUAL_ID);
         _dataTable.Columns[1].ColumnName.ShouldBeEqualTo(CoreConstants.SimulationResults.QUANTITY_PATH);
      ...
      {
         _dataTable.Rows[0][CoreConstants.SimulationResults.INDIVIDUAL_ID].ShouldBeEqualTo(0);
         _dataTable.Rows[0][CoreConstants.SimulationResults.QUANTITY_PATH].ShouldBeEqualTo("Liver");
         ...
         _dataTable.Rows[1][CoreConstants.SimulationResults.INDIVIDUAL_ID].ShouldBeEqualTo(1);
         _dataTable.Rows[1][CoreConstants.SimulationResults.QUANTITY_PATH].ShouldBeEqualTo("Liver");
